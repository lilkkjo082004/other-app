...
export default function App() {
  ...
  function applyState(s) {
    ...
    setRestored({ messages: s.messages || [], chatMode: s.chatMode || 'group', autoSpeak: !!s.autoSpeak, bonds: s.bonds || {}, voiceCall: s.voiceCall, pushFrequency: s.pushFrequency, pushSchedule: s.pushSchedule, memories: s.memories || [], spacePos: s.spacePos || {}, ambientAlerts: s.ambientAlerts, lore: s.lore || [], jokes: s.jokes || [], journal: s.journal || [], goals: s.goals || [] });
    setScreen('chat');
  }
